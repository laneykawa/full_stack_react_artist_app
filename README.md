...
Software Needed: 
  SERVER-SIDE: npm install --save mongoose express body-parser
  CLIENT-SIDE: npm install --save axios create-react-app react-dom react-redux react-router-dom redux
...
ACKNOLEDGEMENTS: 
** Special thanks to Ben Turner and Eric Jones who helped me learn and fix any issues in my code **
